                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="shipping_name" 
                                           ...
                                           required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F95738]">
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="shipping_address" rows="3" required
                                        ...
                                        {{ old('shipping_address', auth()->user()->address ?? '') }}
                                    </textarea>
                                </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
                            ...
                            <div class="space-y-3 pt-4 border-t border-gray-100">
                                ...
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="font-medium">Rp <span id="shipping_display">{{ number_format($shippingCost, 0, ',', '.') }}</span></span>
                                </div>
                                <div class="border-t border-gray-100 pt-3">
                                    <div class="flex justify-between text-lg">
                                        <span class="font-semibold">Total</span>
                                        <span class="font-bold text-[#F95738]">Rp <span id="total_display">{{ number_format($total, 0, ',', '.') }}</span></span>
                                    </div>
                                </div>
                            </div>

                            <button type="submit" id="submitButton" 
                                    class="w-full mt-6 bg-[#F95738] hover:bg-orange-600 text-white py-4 rounded-xl font-semibold transition-all">
                                BUAT PESANAN
                            </button>
