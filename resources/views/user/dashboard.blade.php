<x-user-layout>
    ...
    <div class="relative hero-gradient overflow-hidden min-h-[500px] md:min-h-[600px]">
        ...
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-20 left-10 w-96 h-96 bg-white rounded-full blur-3xl animate-pulse" style="animation-duration: 8s;"></div>
            <div class="absolute bottom-20 right-10 w-[500px] h-[500px] bg-white rounded-full blur-3xl animate-pulse" style="animation-delay: 2s; animation-duration: 10s;"></div>
        </div>

        <!-- Animated Floating Circles -->
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute -top-40 -right-40 w-80 h-80 bg-yellow-400/20 rounded-full blur-3xl animate-[float_25s_ease-in-out_infinite]"></div>
            <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-orange-400/20 rounded-full blur-3xl animate-[float_30s_ease-in-out_infinite_2s]"></div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-white">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="#products" class="bg-white text-[#F95738] px-8 py-4 rounded-full font-bold hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-2xl flex items-center gap-2 focus:outline-none focus-visible:ring-4 focus-visible:ring-white/60 active:scale-95">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                            </svg>
                            Belanja Sekarang
                        </a>
                        <a href="#categories" class="bg-white/20 backdrop-blur-sm text-white px-8 py-4 rounded-full font-bold hover:bg-white/30 transition-all duration-300 border border-white/30 flex items-center gap-2 hover:shadow-lg focus:outline-none focus-visible:ring-4 focus-visible:ring-white/40 active:scale-95">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Recommended Products Showcase (BISA DIKLIK) -->
                            ...
                            <div class="floating-card bg-white/10 backdrop-blur-sm rounded-3xl p-4 transform hover:scale-[1.03] hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl hover:bg-white/15 ring-1 ring-white/10 hover:ring-white/30">
                                <div class="bg-white rounded-2xl h-48 flex items-center justify-center mb-4 overflow-hidden relative shadow-sm">
                                    ...
                                    <button onclick="event.preventDefault()" 
                                            class="absolute bottom-3 right-3 w-10 h-10 bg-[#F95738] hover:bg-orange-600 text-white rounded-full flex items-center justify-center transition-all duration-300 opacity-0 group-hover:opacity-100 hover:scale-110 shadow-lg">
                                ...
                                <h3 class="text-white font-semibold mb-2.5 truncate text-sm leading-snug group-hover:text-yellow-200 transition-colors">{{ $product->name }}</h3>
        ...
        <div class="absolute bottom-0 left-0 right-0 overflow-hidden">
            <svg id="wave" viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-auto">
                <path id="wave-path" d="M0 120L60 105C120 90 240 60 360 45C480 30 600 30 720 37.5C840 45 960 60 1080 67.5C1200 75 1320 75 1380 75L1440 75V120H0Z" fill="#F9FAFB"></path>
            </svg>
        </div>
    </div>
    ...
    <div id="products" class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-12">
                <a href="#" class="inline-block bg-white border-2 border-[#F95738] text-[#F95738] px-10 py-4 rounded-full font-bold hover:bg-[#F95738] hover:text-white transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-[#F95738]/30 hover:shadow-xl active:scale-95 focus:outline-none focus-visible:ring-4 focus-visible:ring-[#F95738]/40">
                    Lihat Semua Produk
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-2xl p-7 text-center shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100/80">
                    <div class="w-16 h-16 mx-auto mb-5 rounded-2xl bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center text-white text-2xl shadow-sm">✓</div>
                ...
                <div class="bg-white rounded-2xl p-7 text-center shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100/80">
                    <div class="w-16 h-16 mx-auto mb-5 rounded-2xl bg-gradient-to-br from-blue-400 to-cyan-500 flex items-center justify-center text-white text-2xl shadow-sm">🚚</div>
                ...
                <div class="bg-white rounded-2xl p-7 text-center shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100/80">
                    <div class="w-16 h-16 mx-auto mb-5 rounded-2xl bg-gradient-to-br from-purple-400 to-violet-500 flex items-center justify-center text-white text-2xl shadow-sm">🔒</div>
                ...
                <div class="bg-white rounded-2xl p-7 text-center shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100/80">
                    <div class="w-16 h-16 mx-auto mb-5 rounded-2xl bg-gradient-to-br from-orange-400 to-amber-500 flex items-center justify-center text-white text-2xl shadow-sm">💬</div>
    ...
    <!-- Back to Top Button (fitur bagus baru) -->
    <button onclick="scrollToTop()" 
            id="backToTop"
            class="fixed bottom-8 right-8 bg-[#F95738] text-white w-12 h-12 rounded-2xl shadow-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 opacity-0 pointer-events-none z-50">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 10l7-7m0 0l7 7" />
        </svg>
    </button>

    <!-- Custom Animations + Smooth Scroll -->
    <style>
        ...
        @keyframes waveMove {
            0%   { d: path("M0 120L60 105C120 90 240 60 360 45C480 30 600 30 720 37.5C840 45 960 60 1080 67.5C1200 75 1320 75 1380 75L1440 75V120H0Z"); }
            50%  { d: path("M0 120L60 100C120 80 240 70 360 55C480 40 600 45 720 50C840 55 960 75 1080 80C1200 85 1320 90 1380 95L1440 95V120H0Z"); }
            100% { d: path("M0 120L60 105C120 90 240 60 360 45C480 30 600 30 720 37.5C840 45 960 60 1080 67.5C1200 75 1320 75 1380 75L1440 75V120H0Z"); }
        }
        #wave-path {
    ...
    <!-- Countdown Timer Script + Back to Top Script -->
    <script>
        // Countdown
