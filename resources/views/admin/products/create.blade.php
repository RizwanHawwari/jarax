<x-admin-layout>
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mt-2">Tambah Produk Baru</h2>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#F95738] transition-colors">
                        ...
                        <label for="imageInput" class="cursor-pointer">
                            ...
                            <p class="text-xs text-gray-400 mt-1">PNG, JPG, GIF maksimal 2MB</p>
                        </label>
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F95738] focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
